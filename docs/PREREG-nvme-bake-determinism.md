...
Registered before the QNAP bake starts. Replaces the split-site *file
...
The QNAP (`.68`, A2000 12 GB, bnb 0.50.0) bakes Qwen3-235B-A22B-Instruct-2507
...
- **D1 (primary):** for every (layer, expert, segment), QNAP `sha256` ==
...
- **D3 (source control):** the QNAP's own source shards must first match
