...
[`examples/dequant_tax.py`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.29.0/examples/dequant_tax.py)
...
[`kernel/`](https://github.com/pjordanandrsn/grouped-nf4-gemm/tree/v0.29.0/kernel)
(`RESULTS-*.md`, `prereg_*.json`). The 235B flagship and the closed
prefetch programme are under
[`bench/phase3/flagship/`](https://github.com/pjordanandrsn/grouped-nf4-gemm/tree/v0.29.0/bench/phase3/flagship).
...
[`REPRO.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.29.0/REPRO.md):
...
[ATTRIBUTION.md](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.29.0/ATTRIBUTION.md).
