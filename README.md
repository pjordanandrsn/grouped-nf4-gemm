...
([receipts](https://github.com/pjordanandrsn/grouped-nf4-gemm/tree/v0.22.0/bench/phase1/results/dequant_forward/leg-e2e),
...
[`projections/`](https://github.com/pjordanandrsn/grouped-nf4-gemm/tree/v0.22.0/projections/)). Both docs are OpenTimestamps-anchored (`.ots`)
