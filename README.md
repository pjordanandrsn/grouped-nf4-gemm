...
- **Serve** ([`RESULTS-mxfp4-serve.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/mxfp4/RESULTS-mxfp4-serve.md)):
...
- **Train** ([`RESULTS-mxfp4-train.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/mxfp4/RESULTS-mxfp4-train.md)):
...
- **Kimi K3** — released, and the per-model STOP gate **PASSED**. That gate said
  ...
  ([`docs/RESULTS-k3-phase1-oracle.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/RESULTS-k3-phase1-oracle.md)).
  ...
  ([`docs/RESULTS-k3-slice-roundtrip.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/RESULTS-k3-slice-roundtrip.md)).
...
[`docs/nvme-ceilings.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/nvme-ceilings.md). What the tier buys is
reachability and provenance, not latency:
[`docs/K3-PROVENANCE-CHAIN.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/K3-PROVENANCE-CHAIN.md) composes the
...
- **Versus the other execution classes** (same-run census on the v6 kernel —
  ...
  says; treat these as measured, not confirmed, [receipts](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase1/results/comparators_v6/RESULTS-comparators-v6.md)):
...
sixth passed clean:
[v1](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-gate2-confirmatory.md) (caught the original per-shape
config table overfitting its census), [v2](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-v2-confirmatory.md)
(validated the replacement single-constant config on 64-SM parts and the
off-census `k≥6` wins), [v3](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-v3-confirmatory.md) (found the
...
[v4](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-v4-confirmatory.md) (dispatch floor + split-K work floor
+ prefill config; caught its own dispatch-point regression),
[v5](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-v5-confirmatory.md) (the load-time dispatch fix, clean on
...
[v6](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-v6-confirmatory.md) (**CONFIRMED**, all five criteria:
...
- **[Phase A](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-offload.md)** (synthetic
  ...
  pays.)
- **[The gap is architectural](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-bnb-baseline.md)** —
...
- **[Phase B](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-phaseB.md)** (the real
...
- **Expert prefetch is measured CLOSED, negative** — four registered arcs
  ([B2](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-phaseB2.md) speculation:
  token-to-token expert stickiness is only 0.44;
  [B3](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-phaseB3.md) early routing: the
  ...
  [B4](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-phaseB4.md) threaded issuance:
  GIL tax, 0.57×;
  [B5](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/bench/phase3/flagship/RESULTS-flagship-phaseB5.md) GPU-driven
...
- **Recommended configuration: `--prefetch-mode gpu`** — expert ids stay
  GPU-resident and a triton kernel ([`kernel/host_gather.py`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/host_gather.py))
...
See [REPRO.md](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/REPRO.md) — suite, benchmark, and verdict reduction are each
...
([`kernel/RESULTS-v6-a2000-report.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/kernel/RESULTS-v6-a2000-report.md)):
...
[`docs/cold-engine/PHASE0-premise.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/docs/cold-engine/PHASE0-premise.md).
...
[`PROJECTIONS-multiarch.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/PROJECTIONS-multiarch.md) (protocol:
[`PROTOCOL-multiarch.md`](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/PROTOCOL-multiarch.md); model + R1 anchor gate:
[`projections/`](https://github.com/pjordanandrsn/grouped-nf4-gemm/tree/v0.8.3/projections/)). Both docs are OpenTimestamps-anchored (`.ots`)
...
MIT ([LICENSE](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/LICENSE)). Portions developed with Claude Code as an AI
assistant under the author's direction and review — see
[ATTRIBUTION.md](https://github.com/pjordanandrsn/grouped-nf4-gemm/blob/v0.8.3/ATTRIBUTION.md). All claims are the author's responsibility.
